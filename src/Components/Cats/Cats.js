...
export default function Cats({}) {
  ...
  useEffect(async () => {
    const res = await axios.get("https://tuwaiq-catsproject.herokuapp.com/cats", {
  ...
  const deleteCats = async (id, index)=>{
    ...
    const deletedCat = await axios.delete(`https://tuwaiq-catsproject.herokuapp.com/cat/${id}`,{
      headers:{authorization: "Bearer " + token},
    });
